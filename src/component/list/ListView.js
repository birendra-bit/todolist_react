...
const ListView = props => {
    ...
    return (
        <div className="row mt-5">
            <div className="mx-auto col-lg-8 col-md-4 col-sm-6 col-xs-6 d-inline">
            <div className="d-flex p-2">
                ...
                {
                        data.isImportant?<i className="fa fa-star ml-auto" aria-hidden="true"/>:
                        <i className="fa fa-star-o ml-auto" aria-hidden="true"/>
                    }
            </div>
            <div>
